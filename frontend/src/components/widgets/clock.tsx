...
export default function Clock() {
    ...
    const theme = getWidgetTheme(searchParams.get('theme'));
    const color = getWidgetColor(searchParams.get('color'));
    ...
    return (
        ...
        >
            <div className="relative flex h-72 w-72 flex-col items-center justify-center overflow-hidden rounded-4xl bg-widget-background font-orbitron shadow-[0_0_32px_0] shadow-[#0F0E0E]/20">
